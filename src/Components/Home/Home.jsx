			...
			>
				...
				>
					...
					<div className={styles.btn}>
						<a
							href='https://drive.google.com/file/d/1HvDzo80LXpLyb8fFbcOpoe23zs3ThOHw/view?usp=sharing' // Resume
							target='blank'
						>
							<Button
								text={
				...
				>
					<img
						src='https://avatars.githubusercontent.com/u/96100046?v=4' //my Picture
						alt='Profile pic'
					/>
				</div>
			</div>
